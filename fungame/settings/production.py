...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["virtgold.com"])
...
AWS_SES_FROM_EMAIL = env(
    ...
    default="VirtGold <no-reply@virtgold.com>",
)
# https://docs.djangoproject.com/en/dev/ref/settings/#server-email
SERVER_EMAIL = env("DJANGO_SERVER_EMAIL", default=AWS_SES_FROM_EMAIL)
